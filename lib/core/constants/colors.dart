...
sealed class AppColors {
  ...
  static const Color antiqueRuby = Color(0xffed080a);
  static const Color deepTeal = Color(0xff40dde5);
  ...
  static const Color transparentColor = Color(0xff000000); //with opacity 24%
}
